...
HD_PWD='D:/EmbeddedVitis/gpio_mio/gpio_mio.runs/gpio_design_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_design_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_design_processing_system7_0_0.tcl
