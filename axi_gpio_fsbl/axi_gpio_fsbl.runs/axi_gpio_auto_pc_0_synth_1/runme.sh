...
HD_PWD='D:/EmbeddedVitis/axi_gpio_fsbl/axi_gpio_fsbl.runs/axi_gpio_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio_auto_pc_0.tcl
