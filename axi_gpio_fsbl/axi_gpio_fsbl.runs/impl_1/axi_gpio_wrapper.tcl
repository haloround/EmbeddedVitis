...
namespace eval ::optrace {
  variable script "D:/EmbeddedVitis/axi_gpio_fsbl/axi_gpio_fsbl.runs/impl_1/axi_gpio_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/EmbeddedVitis/axi_gpio_fsbl/axi_gpio_fsbl.runs/synth_1/axi_gpio_wrapper.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force axi_gpio_wrapper_physopt.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi axi_gpio_wrapper.mmi }
