...
HD_PWD='D:/EmbeddedVitis/custom_ip/axi_dma_loop/axi_dma_loop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_dma_loop_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_dma_loop_wrapper.tcl -notrace
