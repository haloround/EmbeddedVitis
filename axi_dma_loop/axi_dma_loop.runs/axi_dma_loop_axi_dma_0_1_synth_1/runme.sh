...
HD_PWD='D:/EmbeddedVitis/custom_ip/axi_dma_loop/axi_dma_loop.runs/axi_dma_loop_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_dma_loop_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_dma_loop_axi_dma_0_1.tcl
