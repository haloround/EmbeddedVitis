...
HD_PWD='D:/EmbeddedVitis/gpio_emio/gpio_emio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_emio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_emio_wrapper.tcl -notrace
