...
HD_PWD='D:/EmbeddedVitis/gpio_emio/gpio_emio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_emio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_emio_wrapper.tcl
