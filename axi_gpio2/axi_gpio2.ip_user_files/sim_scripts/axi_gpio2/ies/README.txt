...
#
# Generated by export_simulation on Fri Mar 22 22:25:56 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './axi_gpio2.sh' script.

./axi_gpio2.sh -reset_run
...
./axi_gpio2.sh -noclean_files

For more information on the script, please type './axi_gpio2.sh -help'.
