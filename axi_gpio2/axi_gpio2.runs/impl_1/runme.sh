...
HD_PWD='D:/EmbeddedVitis/axi_gpio2/axi_gpio2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_gpio2_wrapper.tcl -notrace
