...
HD_PWD='D:/EmbeddedVitis/axi_gpio2/axi_gpio2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio2_wrapper.tcl
