...
HD_PWD='D:/EmbeddedVitis/axi_gpio2/axi_gpio2.runs/axi_gpio2_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio2_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio2_rst_ps7_0_50M_0.tcl
