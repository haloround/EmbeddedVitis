...
HD_PWD='D:/EmbeddedVitis/custom_ip/user_led/user_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log user_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source user_led_wrapper.tcl -notrace
