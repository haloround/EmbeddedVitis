...
HD_PWD='D:/EmbeddedVitis/custom_ip/user_led/user_led.runs/user_led_breath_led_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_led_breath_led_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_led_breath_led_ip_0_0.tcl
