...
HD_PWD='D:/EmbeddedVitis/custom_ip/user_led/user_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_led_wrapper.tcl
